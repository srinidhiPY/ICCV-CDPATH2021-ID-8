"""
Supervised finetuning (Baseline) of Self-Supervised pretrained model on Camelyon16 dataset
"""
import argparse
import os
import time
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Supervised Finetuning (Baseline) Self-Supervised model on Camelyon16 dataset')
