"""
Supervised finetuning (Baseline) of Self-Supervised pretrained model on MHIST dataset
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Supervised finetuning (Baseline) of Self-Supervised pretrained model on MHIST dataset')
