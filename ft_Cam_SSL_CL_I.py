"""
Finetuning Self-Supervised model on Camelyon16 dataset with Curriculum - I (i.e., easy-to-hard) stage
"""
import argparse
import os
import time
...
def parse_args():
    ...
    parser = argparse.ArgumentParser('Finetuning Self-Supervised model on Camelyon16 dataset with Curriculum - I (i.e., easy-to-hard) stage')
    ...
    parser.add_argument('--lr', default=0.0005, type=float, help='learning rate. - 5e-4(Adam)')
